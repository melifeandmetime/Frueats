...
Route::get('carts_insert/{id}', [\App\Http\Controllers\CartController::class, 'insertCart']);
Route::get('carts_delete/{id}', [\App\Http\Controllers\CartController::class, 'deleteCart']);
Route::post('carts_update/{id}', [\App\Http\Controllers\CartController::class, 'updateCart']);

Route::get('order_payment', [\App\Http\Controllers\OrderShopController::class, 'orderPayment']);
Route::post('order_store', [\App\Http\Controllers\OrderShopController::class, 'orderStore']);
Route::get('order_confirm', [\App\Http\Controllers\OrderShopController::class, 'orderConfirm']);
...
Route::group(['middleware' => 'auth'], function() {
    ...
    Route::group(['middleware' => ['isAdmin'],'prefix' => 'admin', 'as' => 'admin.'], function() {
        ...
        Route::post('categories/upload-photo', [\App\Http\Controllers\Admin\CategoryController::class, 'uploadPhoto'])->name('categories.uploadPhoto');
        ...
        Route::get('order_status/{id}', [\App\Http\Controllers\Admin\OrderController::class, 'updateStatus']);
    });
});
