...
<html lang="zxx">
  <head>
    ...
    <title>FRUEATS</title>
    <link rel="shortcut icon" href="{{ asset('frontend/img/Screenshot_2024-04-25_093647-removebg-preview.png') }}">
    <!-- Google Font -->
    <link
    ...
    .custom_select {
        ...
        max-width: 600px; /* Menentukan lebar maksimal */
  ...
  <body>
    ...
    <div class="humberger__menu__wrapper">
      ...
      <div class="humberger__menu__contact">
        <ul>
          <li><i class="fa fa-envelope"></i>frueats@gmail.com</li>
          <li>Frueats Solusi Belanja Buah Untuk Anda</li>
        </ul>
      </div>
    </div>
    <!-- Humberger End -->
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <nav class="header__menu">
              <ul>
                <li class="active"><a href="/">Home</a></li>
                <li class="active"><a href="{{ url('carts') }}">Cart</a></li>
